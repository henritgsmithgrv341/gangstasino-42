...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-92df4303');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-92df4303');}
...
function clearFlash(){dieView.classList.remove('rl-win-92df4303');dieView.classList.remove('rl-lose-92df4303');if(frameEl){frameEl.classList.remove('rl-win-92df4303');frameEl.classList.remove('rl-lose-92df4303');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-92df4303');if(frameEl){frameEl.classList.add('rl-win-92df4303');}}else{dieView.classList.add('rl-lose-92df4303');if(frameEl){frameEl.classList.add('rl-lose-92df4303');}}
...
var brandEl=document.querySelector('.rl-brand-92df4303');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
